...
# Loading pictures
wall_picture = pygame.image.load("pictures/Mur.png").convert_alpha()
free_picture = pygame.image.load("pictures/libre.png").convert_alpha()
starting_picture = pygame.image.load("pictures/arriver.png").convert_alpha()
guardian_picture = pygame.image.load("pictures/gardien.png").convert_alpha()
needle_picture = pygame.image.load("pictures/aiguille.png").convert_alpha()
ether_picture = pygame.image.load("pictures/ether.png").convert_alpha()
syringe_picture = pygame.image.load("pictures/seringue.png").convert_alpha()
picture_win = pygame.image.load("pictures/gagnez.jpg").convert_alpha()
dead_picture = pygame.image.load("pictures/mort.png").convert_alpha()
hero_picture = pygame.image.load("pictures/macgyver.png").convert_alpha()
